...
export class PlanWorkResolver {
  ...
  async addPlanRootWork(
    @Args('input') inputCreatePlanWork: PlanWorkRegisterInput,
  ) {
  ...
  @UseGuards(GqlAuthGuard)
  @Mutation(() => PlanWorkRegisterDto)
  async updatePlanRootWork(
    @Args('id') id: string,
    @Args('input') inputUpdatePlanWork: PlanWorkRegisterInput,
  ) {
    return await this.planWorkService.updatePlanWorkRoot(
      id,
      inputUpdatePlanWork,
    );
  }
  ...
  async updatePlanWork(@Args('input') inputUpdatePlanWork: PlanWorkUpdate) {
    return await this.planWorkService.addPlanWorkParentInRoot(
      inputUpdatePlanWork,
    );
  }
  //#endregion
  ...
  async updatePlanWorkParent(
    @Args('id') id: string,
    @Args('input') inputUpdatePlanWork: PlanWorkParentRegisterInput,
  ) {
    return await this.planWorkService.updatePlanWorkParent(
      id,
      inputUpdatePlanWork,
    );
  }
  ...
  async addPlanWorkChild(
    @Args('input') inputCreatePlanWork: PlanWorkChildRegisterInput,
  ) {
  ...
  @Mutation(() => PlanWorkUpdateDto)
  async inactivatePlanWork(
    @Args('input') inputUpdatePlanWork: PlanWorkDeleteInput,
  ) {
    return await this.planWorkService.inacvitePlanWorkChild(
      inputUpdatePlanWork,
    );
  }
  @Mutation(() => PlanWorkUpdateDto)
  async updatePlanWorkChild(
    @Args('input') inputUpdatePlanWork: PlanWorkChildUpdate,
  ) {
