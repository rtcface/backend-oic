...
export class UsersResolver {
  ...
  async getColaboresTreeData(
    @Args('input') input: UserColaboradoresQueryInput,
  ) {
  ...
  async updateUser(@Args('input') inputUpdateUser: UserUpdateInput) {
  ...
  @UseGuards(GqlAuthGuard)
  @Mutation(() => UserRegisterdto)
  async inactivateUser(@Args('input') inputDeleteUser: UserDeleteInput) {
